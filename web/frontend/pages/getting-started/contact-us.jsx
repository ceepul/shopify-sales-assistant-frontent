        ...
        <div style ={{marginInline: '12px'}}>
          <Layout>
            <Layout.Section>
              ...
              <div style={{ marginTop: '3rem', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                        ...
                        {isFormSubmitting ? (
                            ...
                            <VerticalStack gap='6'>
                                ...
                                <div style={{ textAlign: 'center' }}>
                                  <Text variant="bodyMd">We're committed to addressing your inquiries. Please anticipate our reply within the next 48 hours.</Text>
                                </div>
